...
class UrgentSupplyPage extends ConsumerStatefulWidget {

  UrgentSupplyPage({Key? key}) : super(key: key);
  @override
  ConsumerState<UrgentSupplyPage> createState() => _UrgentSupplyPage();
}

class _UrgentSupplyPage extends ConsumerState<UrgentSupplyPage> {
    ...
    return Row(
      children: [
        ...
        Padding(
          ...
          child: Text("Acil İlanlar",style: TextStyle(color: appColors.white,fontSize: 18,fontFamily: "FontNormal"),),
        ),
        Spacer(),
        Container(
          width: 30,
                ...
                children: [
                  Padding(
                      ...
                      child: user != null ?  Center(
                              child:getText("Acil Olarak\nPaylaşılmıştır","Bu İlanlar\n", 18, appColors.white),
                            )
    ...
    if(user == null ){
      return Center(
        child: RichText(
          ...
          text: TextSpan(
            children: <TextSpan>[
              TextSpan(text: 'Acil ilanları görmek için\n', style: TextStyle(fontFamily: "FontNormal",color: appColors.pink,fontSize: 15)),
      ...
      return FutureBuilder<List<CombinedInfo>>(
        future: FirestoreService().getUrgentSupplyFromFirestore(),
              ...
              return Center(
                child: RichText(
                  ...
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      TextSpan(text: 'Henüz', style: TextStyle(fontFamily: "FontNormal",color: appColors.pink)),
                      TextSpan(text: ' acil ilan ',style: TextStyle(fontFamily: "FontBold",color: appColors.pink)),
                      TextSpan(text: 'yok',style: TextStyle(fontFamily: "FontNormal",color: appColors.pink)),
                    ],
                  ),
                ),
              );
